/**
 * Body Signals Game
 * Learn what physical sensations mean emotionally
 */
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Body Signals</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.benefit, { color: colors.tint }]}>
          Builds: Interoceptive awareness, somatic education
        </Text>
