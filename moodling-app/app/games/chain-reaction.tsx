/**
 * Chain Reaction Game
 * Connect cause to effect to feeling to behavior chains
 */
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Chain Reaction</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.benefit, { color: colors.tint }]}>
          Builds: Understanding emotional patterns
        </Text>
