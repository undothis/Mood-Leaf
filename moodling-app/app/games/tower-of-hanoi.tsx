/**
 * Tower of Hanoi Game
 * Move discs between towers. Builds patience and planning
 */
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Tower of Hanoi</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.benefit, { color: colors.tint }]}>
          Builds: Planning, patience, recursive thinking
        </Text>
