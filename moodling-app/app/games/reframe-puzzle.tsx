/**
 * Reframe Puzzle Game
 * Rearrange word tiles to turn negative thoughts into positive
 */
...
export default function ReframePuzzleScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Reframe Puzzle</Text>
